...
public class AssetLoaderTest {
    ...
    @Test
    public void testLoadWebjarBowerJS() {
        AssetLoader assetLoader = new AssetLoader();
        String result = assetLoader.convert("webjar:angular-screenmatch.js", null);
        assertEquals("<script type=\"text/javascript\" src=\"webjars/angular-screenmatch/1.0.1/src/angular-screenmatch.js\"> </script>", result);
    }
